...
<style>
  ...
  .fab-variant {
    ...
    background: linear-gradient(135deg, color-mix(in srgb, var(--primary) 40%, transparent), color-mix(in srgb, var(--primary-foreground) 40%, transparent));
    background: linear-gradient(135deg, rgba(16,185,129,0.4), rgba(6,214,160,0.4));
    z-index: 110;
  }
  ...
  /* Color variants */
  .rt-btn[data-color="primary"] { background: linear-gradient(135deg, color-mix(in srgb, var(--primary) 40%, transparent), color-mix(in srgb, var(--primary-foreground) 40%, transparent)); box-shadow: 0 6px 16px color-mix(in srgb, var(--primary) 48%, transparent); background: linear-gradient(135deg, rgba(16,185,129,0.4), rgba(6,214,160,0.4)); box-shadow: 0 6px 16px rgba(16,185,129,0.48); }
  .rt-btn[data-color="danger"] { background: linear-gradient(135deg, color-mix(in srgb, var(--destructive) 40%, transparent), color-mix(in srgb, var(--destructive) 36%, transparent)); box-shadow: 0 6px 16px color-mix(in srgb, var(--destructive) 48%, transparent); background: linear-gradient(135deg, rgba(239,68,68,0.4), rgba(220,38,38,0.36)); box-shadow: 0 6px 16px rgba(239,68,68,0.48); }
  .rt-btn[data-color="neutral"] { background: color-mix(in srgb, var(--foreground) 40%, transparent); box-shadow: 0 6px 16px color-mix(in srgb, var(--foreground) 44%, transparent); background: rgba(255,255,255,0.4); box-shadow: 0 6px 16px rgba(0,0,0,0.48); }
  .rt-btn[data-color="accent"] { background: linear-gradient(135deg, color-mix(in srgb, var(--accent) 40%, transparent), color-mix(in srgb, var(--accent-foreground) 40%, transparent)); box-shadow: 0 6px 16px color-mix(in srgb, var(--accent) 48%, transparent); background: linear-gradient(135deg, rgba(139,92,246,0.4), rgba(124,58,237,0.4)); box-shadow: 0 6px 16px rgba(139,92,246,0.48); }
  .rt-btn[data-color="primary"], .rt-btn[data-color="accent"], .rt-btn[data-color="danger"] { color: white; }

  /* Hover color-specific shadows */
  .rt-btn:hover[data-color="primary"] { box-shadow: 0 10px 28px color-mix(in srgb, var(--primary) 56%, transparent); }
  .rt-btn:hover[data-color="danger"] { box-shadow: 0 10px 28px color-mix(in srgb, var(--destructive) 56%, transparent); }
  .rt-btn:hover[data-color="accent"] { box-shadow: 0 10px 28px color-mix(in srgb, var(--accent) 56%, transparent); }
</style>
